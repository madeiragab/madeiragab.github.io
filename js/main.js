...
const PROJETOS_FALLBACK = [
  { name: 'lastro', categoria: 'cat.tool', tech: 'Rust · B+Tree · WAL', description: 'Banco de dados relacional embutido escrito do zero em Rust: pager, B+Tree, WAL com recuperação de crash, parser SQL e MVCC.', html_url: 'https://github.com/madeiragab/lastro', stargazers_count: 0 },
